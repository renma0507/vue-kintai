    ...
    <div class="main">
      ...
      <div class="table-area">
        ...
        <table class="time-table">
          ...
          <tbody>
            <tr>
              <td><input type="time" v-model="editedTime.startTime" /></td>
              <td><input type="time" v-model="editedTime.endTime" /></td>
              <td><input type="time" v-model="editedTime.breakStart" /></td>
              <td><input type="time" v-model="editedTime.breakEnd" /></td>
            </tr>
          </tbody>
        </table>
      </div>
